      ...
      <div style={{ position: 'relative', zIndex: 10,
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column',
          ...
          <motion.div {...fu(0.4)} className="liquid-glass"
            ...
            <span style={{ background: 'white', color: '#000',
                           ...
                           fontFamily: 'Barlow, sans-serif' }}>Open to Work</span>
          ...
          {/* Sub-headline */}
          <motion.p {...fu(0.8)}
            style={{ marginTop: '1rem', fontSize: '0.9375rem', color: 'white',
        ...
        <motion.div {...fu(1.4)}
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '3rem', flexWrap: 'wrap',
            ...
            {techStack.map(t => (
              <span key={t} style={{ fontFamily: "'Instrument Serif', serif", fontStyle: 'italic',
                                     fontSize: '1.875rem', letterSpacing: '-0.025em' }}>{t}</span>
            ))}
          </div>
        </motion.div>
      </div>
